    ...
    <>
      <div className="md:px-10 mx-0 px-4 lg:mx-48 mt-28 lg:px-24 flex gap-6 h-full flex-col z-10 pb-14 text-article ">
        ...
        <p>
          ...
          <a
            href="https://drive.google.com/file/d/1UiwdEsYgGFiKJXmh0Yi7o5pHBcUa-1aN/preview"
        ...
        <iframe
          src="https://drive.google.com/file/d/1UiwdEsYgGFiKJXmh0Yi7o5pHBcUa-1aN/preview"
